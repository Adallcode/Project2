...
Vector3 Vector3::TransformByQuaternion(const Vector3 & v, const Quaternion & q)
{
...
const Matrix4 Matrix4::Identity(temp);

Vector3 Matrix4::TransformVector3(const Vector3 & a)
{
	Vector3 temp = a;
 
	temp.x = a.x * mat[0][0] + a.y * mat[1][0] + a.z * mat[2][0] + mat[3][0];
	temp.y = a.x * mat[0][1] + a.y * mat[1][1] + a.z * mat[2][1] + mat[3][1];
	temp.z = a.x * mat[0][2] + a.y * mat[1][2] + a.z * mat[2][2] + mat[3][2];
...
//Quaternion
const Quaternion Quaternion::Identity(0.f, 0.f, 0.f, 1.0f);
